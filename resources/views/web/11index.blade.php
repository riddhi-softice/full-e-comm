                            ...
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)"
                                        srcset="{{ asset('public/assets/images/slider/01.png') }}">
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    ...
                                    <img src="{{ asset('public/assets/images/slider/2.png') }}" alt="Image Desc">
                                </picture>
                            </figure>
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    ...
                                    <img src="{{ asset('public/assets/images/slider/4x.png') }}" alt="Image Desc">
                                </picture>
                            </figure>
                            <!-- <div class="intro-content">

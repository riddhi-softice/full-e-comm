...
<div class="page-content">
    ...
    <div class="container">
        <div class="heading">
            ...
            <p class="title-desc">Last updated: May 17, 2025</p>
        </div>
        ...
        <p>We use Cookies and similar tracking technologies to track activity and store certain info. These may include:
        </p>
        <ul>
            <li><strong>Cookies or Browser Cookies:</strong> Small files placed on Your device. You may set Your browser
                to refuse all cookies, but some features may not work without them.</li>
            <li><strong>Web Beacons:</strong> Small electronic files (e.g., pixel tags) used to count users or measure
                site/email performance.</li>
        </ul>
        <p>Cookies can be "Persistent" or "Session" based. Persistent cookies stay after you close your browser, while
            Session cookies are deleted upon closing.</p>

        <p>We use both types for:</p>
        <ul>
            <li><strong>Essential Cookies:</strong> (Session) Needed for core functionality and security. Administered
                by us.</li>
            <li><strong>Acceptance Cookies:</strong> (Persistent) Remember your cookie consent status. Administered by
                us.</li>
            <li><strong>Functionality Cookies:</strong> (Persistent) Remember your settings and preferences.
                Administered by us.</li>
        </ul>

        <p>For more info, refer to our Cookies Policy.</p>
        <br>
        <h3 class="title">Use of Your Personal Data</h3>
        <p>The Company may use Personal Data for the following purposes:</p>
        <ul>
            <li><strong>To provide and maintain our Service</strong>, including monitoring usage.</li>
            <li><strong>To manage Your Account:</strong> providing access to features available to registered users.
            </li>
            <li><strong>For the performance of a contract:</strong> handling purchase or service contracts.</li>
            <li><strong>To contact You:</strong> via email, phone, SMS, or app notifications for updates and support.
            </li>
            <li><strong>To provide You</strong> with promotions and similar offers unless opted out.</li>
            <li><strong>To manage Your requests:</strong> for support or other inquiries.</li>
            <li><strong>For business transfers:</strong> in the case of restructuring, sale, or merger of the company.
            </li>
            <li><strong>For other purposes:</strong> like data analysis, improvement of service, marketing, and
        ...
        <br>
        <h3 class="title">Retention of Your Personal Data</h3>
        ...
        <br>
        <h3 class="title">Transfer of Your Personal Data</h3>
        ...
        <br>
        <h3 class="title">Delete Your Personal Data</h3>
        ...
        <br>
        <h3 class="title">Disclosure of Your Personal Data</h3>
        <br>
        <h4 class="title">Business Transactions</h4>
        ...
        <br>
        <h4 class="title">Other legal requirements</h4>
        ...
        <br>
        <h3 class="title">Security of Your Personal Data</h3>
        ...
        <ul>
            <li><strong>Phone:</strong> <a href="https://wa.me/917016126901?text=Hello">+91 7016126901</a></li>
            <li><strong>Email:</strong> <a href="#"> reachgemsandjewellery@gmail.com</a></li>
        </ul>
    </div>
